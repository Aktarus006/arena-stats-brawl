...
| 015 | L | [[Matches/015 - Amalia|Amalia]] |
...
| # | Result | Opponent |
|---:|:---:|---|
| 051 | L | [[Matches/051 - Sephiroth|Sephiroth]] |
| 052 | W | [[Matches/052 - Ketramose|Ketramose]] |
| 053 | L | [[Matches/053 - Narset Enlightened Master|Narset, Enlightened Master]] |
...
Each new match gets its own `Matches/NNN - Opponent.md` note with YAML metadata. After every game, also review/update the current version tracker, Overview, Matchups, Card Performance, Dashboard and Observed Meta when the new result changes those summaries. Decklist/Changelog are reviewed every game but only modified when the actual list/version changes.
